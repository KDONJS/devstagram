      ...
      <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST" novalidate>
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div>
            ...
            <input id="user-name" name="user-name" type="text"   class="appearance-none relative block w-full px-3 py-2 border  placeholder-gray-500 text-gray-900  rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm @error('user-name') border-red-500 @enderror" placeholder="Usuario">
            @error('user-name')
            <br>
              <div class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                  <span class="font-medium">Alerta!</span> {{$message}}
